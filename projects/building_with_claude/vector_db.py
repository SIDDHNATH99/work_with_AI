...
## Helper Class with semantic search system 
class VectorIndex:
    def __init__(
        self,
...
# 3. Create a vector store and add each embedding to it (converted to a bulk operation to avoid rate limiting errors from VoyageAI)
store = VectorIndex()
